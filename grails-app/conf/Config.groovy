...
environments {
	production {
		baseUrl = System.getProperty("streamr.url") ?: "https://app.pravah.io"
	}
}
...
unifina.reports.recipient = "report@soket.in"
...
unifina.email.sender = "hi@pravah.io"
...
unifina.email.feedback.recipient = "hi@pravah.io"
